...
import Modelo.Array_cliente;
import Modelo.Array_producto;
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        for(Producto objetoproducto:Array_producto.arrayproducto)
                                {
                                    if(objetoproducto.getNombre().equals(nombrebuscar))
                                    {
                                        ...
                                        if(existenciaactual>=existenciacomprar)
                                        {
                                            ...
                                            for(Cliente objetocliente:Array_cliente.arrayclientes)
                                            {
